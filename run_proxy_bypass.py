...
async def main():
    ...
    token = "eyJhbGciOiJIUzUxMiJ9.eyJzdWIiOiIxMzA5MTEwMTAwMDQ0MDIxNzYwIiwiaWF0IjoxNzM0ODU1ODQyLCJleHAiOjE3MzYwNjU0NDJ9.PJHnTYcvPNJTZEvHcxdW2wAvpyjZHy9tp2MLn7IZrw5pVHMHWMBQ2YMtpngv9wIKVVchyjPNHs6U5zEw_xEuIg".strip()
    if not token:
